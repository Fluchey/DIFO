...
\end{lstlisting}
More information about the files can be obtained by using the file command:
...
\subsection{Foremost}
Using the Linux tool foremost\footnote{\url{https://en.wikipedia.org/wiki/Foremost_(software)}}
