...
\end{lstlisting}
The extracted .ole file failed to open in any recommended software. Both 'Suspicious\textunderscore File' and the extracted .ole file were submitted to malware scanning sites VirusTotal\footnote{\url{https://www.virustotal.com/\#/home/upload}}
 and Cryptam\footnote{\url{https://www.cryptam.com/}}
